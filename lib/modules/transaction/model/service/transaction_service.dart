...
abstract class TransactionService {
  Future<ApiResponse> transactionList({required String branchId,required String customerOrSupplierId});
...
class TransactionRemoteDataSource extends TransactionService {
  ...
  @override
  Future<ApiResponse> transactionList({required String branchId,required String customerOrSupplierId}) async {
