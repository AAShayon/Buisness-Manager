...
/// customer : {"id":40,"company_id":66,"branch_id":126,"user_id":66,"name":"asd","phone":"01000005546","email":"tesc@gmail.com","type":1,"balance":"0.00","reminder_date":null,"image":null,"address":"dhaka","area":"dhaka","post_code":"1612","city":"dhaka","state":"dhaka","status":1,"created_by":66,"created_at":"2024-05-18 13:56:36","updated_by":66,"updated_at":"2024-05-18 13:56:36","deleted":0,"deleted_by":null,"deleted_at":null,"show_image":null}
/// customer_bank_accounts : [{"id":34,"customer_id":40,"bank_name":null,"account_name":"oalid","account_number":"23423423","routing_number":"dhanmondi","swift_code":"231","status":1,"created_by":66,"created_at":"2024-05-18 13:56:36","updated_by":66,"updated_at":"2024-05-18 13:56:36","deleted":0,"deleted_by":null,"deleted_at":null}]

SupplierCreateResponseModel supplierCreateResponseModelFromJson(String str) => SupplierCreateResponseModel.fromJson(json.decode(str));
String supplierCreateResponseModelToJson(SupplierCreateResponseModel data) => json.encode(data.toJson());
class SupplierCreateResponseModel {
  SupplierCreateResponseModel({
      dynamic status, 
      dynamic msg, 
      dynamic description, 
      Customer? customer, 
  ...
  SupplierCreateResponseModel.fromJson(dynamic json) {
    _status = json['status'];
    _msg = json['msg'];
...
SupplierCreateResponseModel copyWith({  dynamic status,
  dynamic msg,
  dynamic description,
  Customer? customer,
  List<CustomerBankAccounts>? customerBankAccounts,
}) => SupplierCreateResponseModel(  status: status ?? _status,
  msg: msg ?? _msg,
